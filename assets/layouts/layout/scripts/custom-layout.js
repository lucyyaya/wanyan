...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
		...
		var map = $('.map');   //___CUSTOM___ to handle GIS Map sizing
        var body = $('body');
        var height;
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
			...
			map.css('height', height); //___CUSTOM___ to handle GIS Map sizing
            content.css('min-height', height);
        }
		
    };
	
	//***___CUSTOM___ to handle GIS Map sizing  **//
	//resize content window when windows size change
	...
	//When page load resize content window
	...
	//When page change resize content window
    ...
    var handleSidebarMenu = function () {
        ...
        if (App.isAngularJsApp()) {
            $(".page-sidebar-menu li > a").on("click", function(e) {
                console.log(App.getViewPort().width,resBreakpointMd,$(this).next().hasClass('sub-menu'));
